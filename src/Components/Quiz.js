...
import QuizIcon from '@mui/icons-material/Quiz';import FormGroup from '@mui/material/FormGroup';
...
export default function Quiz(){
    const paperStyle={padding:20,height:'550vh',width:800,margin:'20px auto' }
